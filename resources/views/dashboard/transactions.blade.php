...
<style>
    ...
    /* Ensure table-responsive scrolls */
    .table-responsive {
        overflow-x: auto;
    ...
    <div class="container-fluid p-0">
        ...
        <div
            ...
            <div class="text-muted small">
                {{ \App\Models\CurrencySetting::getActive()->currency_symbol ?? '$' }} Balance: {{
                \App\Helpers\CurrencyHelper::format(Auth::user()->balance ?? 0) }}
            </div>
        </div>
            ...
            <div class="table-responsive desktop-table">
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $loop->iteration + ($transaction->currentPage() - 1) * $transaction->perPage() }}
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                                    <div
                                        class="transaction-icon {{ stripos($item->transaction_type, 'deposit') !== false ? 'icon-deposit' : (stripos($item->transaction_type, 'withdrawal') !== false ? 'icon-withdrawal' : 'icon-other') }}">
                                        <i data-feather="{{ stripos($item->transaction_type, 'deposit') !== false ? 'log-in' : (stripos($item->transaction_type, 'withdrawal') !== false ? 'log-out' : 'activity') }}"
