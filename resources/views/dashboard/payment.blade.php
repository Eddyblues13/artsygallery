<div class="text-center mt-4">
    <div class="payment-title" style="margin:10px">
        <div>
            ...
            @endforeach
            <button type='submit' onclick="copyAdr1()" class='btn btn-primary btn-sm btn-rounded shadow'> Copy
                Address</button>
        </div>
    </div>
</div>
...
<div id="uploadProofForm" style="display: none;" class="card mt-4">
    <div class="card-body">
        <div class="container-fluid p-0">
            <form class='form-horizontal' action="{{ route('make.payment')}}" method='POST' id='id_load'
