									...
									<div class="card-header bg-primary text-white">
										<h5 class="card-title mb-0">
											<i class="align-middle"
												data-feather="{{ $method->getMaskedDetails()['icon'] }}"></i>
											{{ $method->getMaskedDetails()['type'] }}
										</h5>
									</div>
									<div class="card-body">
										<p class="card-text"><strong>Details:</strong><br>{{
											$method->getMaskedDetails()['details'] }}</p>
										<p class="text-muted small">Linked {{ $method->created_at->diffForHumans() }}
										</p>
									</div>
									<div class="card-footer bg-light">
										<div class="d-grid gap-2">
											<a href="{{ route('link.withdrawal.method', $method->method_type) }}"
												class="btn btn-sm btn-primary">
												<i class="align-middle" data-feather="edit-2"></i> Update
											</a>
											<form method="POST"
												action="{{ route('delete.linked.method', $method->id) }}"
						...
						<div class="alert alert-info">
							<div class="d-flex align-items-center">
								...
								<div>
									...
									<p class="mb-0">You haven't linked any withdrawal methods yet. Link a method to
										start withdrawing funds.</p>
								</div>
							</div>
						</div>
						@endif
						...
						<div class="mt-4">
							...
							<div class="row">
								<div class="col-md-6 col-lg-3 mb-3">
									<a href="{{ route('link.withdrawal.method', 'bank') }}"
								...
								<div class="col-md-6 col-lg-3 mb-3">
									...
									<a href="{{ route('link.withdrawal.method', 'paypal') }}"
										class="btn btn-outline-warning w-100 py-3">
										<i class="align-middle" data-feather="mail"></i><br>PayPal
									</a>
								</div>
								<div class="col-md-6 col-lg-3 mb-3">
									<a href="{{ route('link.withdrawal.method', 'other') }}"
