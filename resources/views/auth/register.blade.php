                        ...
                        <div class="row">
                            <div class="col-7">
                                <div class="text-primary p-4">
                                    ...
                                    <p>Get your free Artsygalley account now.</p>
                                </div>
                            </div>
                        ...
                        <div class="p-2">
                            <form method="POST" action="{{ route('register') }}" id="regester" class="needs-validation"
                                ...
                                <div class="mt-4 text-center">
                                    <p class="mb-0">By registering you agree to the artsygalley.com <a href="#"
...
<div class="position-fixed top-0 end-0 p-2" style="z-index: 1005">
    <div id="ErrorToast" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
        <div class="toast-header">
            <img src="https://Artsygalley.online/user/logo.png" alt="" class="me-2" height="18">
