...
@section('content')
<h1>Your Artwork Has Been Sold!</h1>
<p>Dear {{ $data['name'] }},</p>
<p>Great news! Your artwork has been sold on the ArtistToCollectors marketplace.</p>

<div class="info-card">
    <p><span class="label">Artwork Name:</span> <span class="value">{{ $data['nft_name'] }}</span></p>
    <p><span class="label">Sale Price:</span> <span class="value">{{ $data['price_formatted'] }}</span></p>
    ...
    <p><span class="label">Status:</span> <span class="value" style="color:#059669;">Sold</span></p>
</div>

<p>Congratulations on the sale! You can view your artwork history from your dashboard.</p>
