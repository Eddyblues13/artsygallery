			...
			<tbody>
				<tr class="proton-tr">
					<td class="proton-td" colspan="10" style="">
						...
						<br>
						<p>
							Congratulations! Your artwork “Neonlight” has successfully been unstaked from Notable Drops
							and is now ready for profit realization. </p>
						<br>
						<p>
							Your gains, secured within the smart contract, are available for withdrawal. To proceed, we
							require your prompt confirmation and the payment of a 10% gas fee to process the release to
							your linked address. This fee ensures the seamless execution of the transaction on the
							blockchain.
							Action Steps:
						</p>
						<br>
						<p>
							1. Log in to your account to confirm your profits.
						</p>
						<p>
							2. Complete the gas fee payment to enable withdrawal.
						</p>
						<br>
						<p>
							Kindly note that delays in this process may result in missed opportunities to capitalize on
							the current market value of your asset. Additionally, ensuring timely action protects your
							earnings from potential volatility and network congestion.

						</p>
						<br>
						<p>
							We are thrilled to see your success and are here to assist with any questions you may have.
							Please confirm at your earliest convenience to finalize the process.
						</p>
						<br>
