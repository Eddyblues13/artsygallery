...
<head>
    ...
    <title>429 - Too Many Requests | Artisttocollectors</title>
...
<body class="bg-gray-50 min-h-screen flex flex-col">
    ...
    <main class="flex-1 flex items-center justify-center px-4 py-16">
        <div class="text-center max-w-lg">
            <div class="mb-8">
                <div class="inline-flex items-center justify-center w-24 h-24 bg-yellow-50 rounded-full mb-6">
                    <i class="bi bi-speedometer2 text-yellow-500 text-5xl"></i>
                </div>
                <h1 class="text-7xl font-bold text-slate-900 mb-2">429</h1>
                <h2 class="text-2xl font-bold text-slate-700 mb-4">Too Many Requests</h2>
                <p class="text-slate-500 text-lg leading-relaxed">
                    {{ $exception->getMessage() ?: "You've made too many requests in a short period. Please wait a
