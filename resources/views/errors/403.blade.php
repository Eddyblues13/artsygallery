...
<head>
    ...
    <title>403 - Forbidden | Artisttocollectors</title>
        ...
        <div class="text-center max-w-lg">
            <div class="mb-8">
                <div class="inline-flex items-center justify-center w-24 h-24 bg-orange-50 rounded-full mb-6">
                    <i class="bi bi-slash-circle text-orange-500 text-5xl"></i>
                </div>
                <h1 class="text-7xl font-bold text-slate-900 mb-2">403</h1>
                <h2 class="text-2xl font-bold text-slate-700 mb-4">Access Forbidden</h2>
                <p class="text-slate-500 text-lg leading-relaxed">
                    {{ $exception->getMessage() ?: "You don't have permission to access this resource. If you believe
