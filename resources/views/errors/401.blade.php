...
<head>
    ...
    <title>401 - Unauthorized | Artisttocollectors</title>
        ...
        <div class="text-center max-w-lg">
            <div class="mb-8">
                <div class="inline-flex items-center justify-center w-24 h-24 bg-red-50 rounded-full mb-6">
                    <i class="bi bi-shield-lock text-red-500 text-5xl"></i>
                </div>
                <h1 class="text-7xl font-bold text-slate-900 mb-2">401</h1>
                <h2 class="text-2xl font-bold text-slate-700 mb-4">Unauthorized</h2>
                <p class="text-slate-500 text-lg leading-relaxed">
                    {{ $exception->getMessage() ?: 'You need to be authenticated to access this page. Please log in and
                    try again.' }}
                </p>
            </div>
