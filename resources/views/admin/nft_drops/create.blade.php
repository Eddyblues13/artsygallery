...
<div class="main-header d-flex align-items-center justify-content-between position-relative mb-4">
    <div class="d-flex align-items-center gap-3">
        ...
        <div class="page-title d-none d-md-block">
            <h5 class="mb-0">Add New Notable Drop</h5>
        </div>
    </div>
    ...
    <div class="col-lg-8 mx-auto">
        <div class="card shadow-sm border-0">
            <div class="card-body p-4">
                <form id="dropCreateForm" action="{{ route('admin.nft-drops.store') }}" method="POST"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                            name="name" value="{{ old('name') }}" placeholder="e.g. CryptoPunk #3100" required>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="upload-zone @error('image_url') border-danger @enderror" id="uploadZone">
                            <div class="upload-zone-inner" id="uploadPrompt">
                                ...
                                <p class="mb-1 mt-2 fw-semibold">Drag &amp; drop or click to upload</p>
                                <p class="text-muted small mb-0">JPEG, PNG, GIF, WEBP — max 2 MB</p>
                            </div>
                            <div id="uploadPreviewWrap" class="d-none text-center">
                            ...
                            <input type="file" id="image_url" name="image_url" accept="image/*"
                                class="upload-file-input" required>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" step="0.00000001" min="0"
                                    ...
                                    name="eth_value" value="{{ old('eth_value') }}" placeholder="0.00000000" required
                                    readonly>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" step="0.01"
                                    ...
                                    value="{{ old('change') }}" placeholder="0.00" required>
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="number" min="1" class="form-control @error('duration') is-invalid @enderror"
                                id="duration" name="duration" value="{{ old('duration') }}" placeholder="30" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('is_positive') is-invalid @enderror" id="is_positive"
                                ...
                                <option value="1" {{ old('is_positive','1')=='1' ? 'selected' :'' }}>&#8593; Positive
                                    (gain)</option>
                                <option value="0" {{ old('is_positive')=='0' ? 'selected' :'' }}>&#8595; Negative (loss)
                                </option>
                            </select>
                    ...
                    <div class="mb-4">
                        ...
                        <div id="selectedUserBadge" class="mt-2 d-none">
                            <span class="badge bg-indigo text-white py-2 px-3 d-inline-flex align-items-center gap-2"
                                style="background:#6366f1 !important; border-radius:8px;">
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary px-4" id="submitBtn">
                            <span id="submitBtnText"><i class="bi bi-plus-circle me-1"></i>Create Drop</span>
...
<script>
    ...
    const form        = document.getElementById('dropCreateForm');
    ...
    fetch('{{ route('api.eth.price') }}', { headers: { 'X-Requested-With': 'XMLHttpRequest' } })
        ...
        .then(data => {
            ...
            if (!usdValueInput.value && ethValueInput.value) {
    ...
    form.addEventListener('submit', function (e) {
        ...
        xhr.addEventListener('load', () => {
            ...
            // Follow the redirect response from Laravel
            if (xhr.responseURL) {
