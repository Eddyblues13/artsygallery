		...
		<div class="col-xl-12">
				<div class="card" style="border-top-left-radius:30px; border-top-right-radius: 30px; ">
					<div class="card-body">
						...
						<center><p class="card-title" id="someDiv">Send Mail</p></center>
					</div>
					...
					<div class="card-body">
                      ...
                      <textarea class="form-control" id="exampleTextarea1" rows="4" name="message"></textarea>
							...
							<div class="row justify-content-end">
								<div class="col-sm-9">
									<div>
										<button id="send_pin" onclick='send(this)' class="btn btn-primary btn-rounded waves-effect waves-light" type="submit">Send Mail</button>
									</div>
								</div>
							</div>
						</form>
